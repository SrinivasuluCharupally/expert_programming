...
// this is optimized solution, philosopher picks left/large stick first then picks right/small one, put down left one back if right one is not free

// source https://web.mst.edu/~ercal/284/ThreadExamples/Thread-phil.c
