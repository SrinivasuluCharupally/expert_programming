...
//Before : The client creates "product" objects directly, 
//and must embed all possible platform permutations in nasty looking code.
...
//After
//==============================================
//The client receives a platform-specific factory object, 
//which encapsulates use of "new" operator. Client delegates 
//all creation requests to this factory.
